describe('Cypress Tests', () => {
    it('Create Vacancy Positive Test', () => {
        cy.fixture('need/CreateNeedPositiveTest').then(data => {
            ...
            cy.get('body > div:nth-child(15) > div.desktop-modal > div > div.vacancy-need-wrapper > form > div.form__buttons > button').click({force: true})
        })
    })
})